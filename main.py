...
def add_func():
    ...
    tk.Button(root, text="Add", command=main_win, font=("Arial", 15)).grid(row=1, column=1, padx=5, pady=5,sticky='ew')
    ...
    labeloption3 = tk.Label(frame_checks, text="Which day?", font=("Arial", 15), anchor="w")
    def update_checks(*args):
        if wybor.get() == "Every x":
